...
function Home() {
  ...
  useEffect(() => {
    axios.get(`https://http-localhost-3001.onrender.com/scenarios`).then((response) => {
      setScenarios(response.data);
    });

    axios.get(`https://http-localhost-3001.onrender.com/vehicles`).then((response) => {
      setVehicles(response.data);
      setRefreshRequireVehicles(!refreshRequireVehicles);
    });
  }, [isRefresh,refreshRequireVehicles]);
  ...
  }, [scenario, refreshRequireVehicles,vehicles]);
